    ...
    <section class="flex flex-col flex-1 gap-4 mt-2">
        <div class="flex items-center gap-4 justify-between">
            ...
            <div class="flex gap-2 items-center">
                <ButtonTertiary text="Create Permission" @click="addItem">
                    <template #icon>
...
<script setup>
const title = ref("Master Permission");
...
function addItem() {
    router.push(`/admin/permission/create`);
}
function editItem(item) {
    router.push(`/admin/permission/${item.id}/edit`);
}
function showItem(item) {
    router.push(`/admin/permission/${item.id}/show`);
}
